            ...
            <nav class="navbar navbar-expand-lg" style="background-color: rgb(37,39,35);"> <!-- navbar-dark bg-dark -->
                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                      <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                        <button class="btn btn-info navbar-btn" onclick="location.href=''">Directores</button>
                            <!--<a class="nav-link" href="../enviar/">Enviar documento</a>-->
                        </li>
                        &nbsp;
                        &nbsp;
                        <li class="nav-item">
                        <button class="btn btn-outline-info navbar-btn" onclick="location.href='sub.php'">Otros</button>
                            <!--<a class="nav-link" href="../enviar/">Enviar documento</a>-->
                        </li>
                        &nbsp;
                        &nbsp;
                        ...
                        <strong><h1 class="lead" style="color: white;">REGISTRO DE DIRECTORES</h1></strong>
                        &nbsp;
                        &nbsp;
                      </ul>
    ...
    <div class="row justify-content-center bg-light" style="border-style:solid; border:5px;">
        ...
        <div class="row justify-content-center py-3">
            ...
            <div class="form-inline row">
                ...
                <input type="text" class="form-control" style="width: 500px;" id="nombre" name="nombre" maxlength="100" placeholder="Escribe tu nombre" required>
              </div>

                <div class="row form-inline py-2">
                  <label for="titulo">Apellido paterno &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                  <input type="text" class="form-control" style="width: 500px;" id="apellido_p" name="apellido_p" maxlength="100" placeholder="Escribe tu apellido paterno" required>
                </div>

                <div class="row form-inline py-2">
                  <label for="titulo">Apellido materno &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                  <input type="text" class="form-control" style="width: 500px;" id="apellido_m" name="apellido_m" maxlength="100" placeholder="Escribe tu apellido materno" required>
                </div>

                <div class="row form-inline py-2">
                  <label for="titulo">Dirección &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
                  <input type="text" class="form-control" style="width: 500px;" id="direccion" name="direccion" maxlength="200" placeholder="Director de... " required>
                </div>

                <div class="row form-inline py-2">
                  <label for="titulo">Correo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
                  <input type="email" class="form-control" style="width: 500px;" id="email" name="email" maxlength="100" placeholder="tucorreo@correo.com" required>
                </div>
                <div class="row form-inline py-2">
